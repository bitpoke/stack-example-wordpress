			...
			$_configs = array(
				...
				*/
				...
				array(
					...
					'section'   => 'section-woo-shop-single',
					'priority'  => 10,
					'title'     => __( 'Show MasterCard', 'astra' ),
					'transport' => 'postMessage',
				),
