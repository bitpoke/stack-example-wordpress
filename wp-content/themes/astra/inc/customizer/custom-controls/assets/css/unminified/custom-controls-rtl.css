...
.ast-border-wrapper.desktop .ast-border-input-item:nth-child( n + 2 ) .ast-border-input:focus {
	border-right: 1px solid var( --ast-customizer-color-1 );
}
...
.ast-upgrade-pro-wrap .ast-button-link {
	...
	background: linear-gradient(-90deg, #EB1B99 -23.83%, #321978 28.86%, #321978 49.67%, #321978 74.52%, #5810FF 109.73%);
...
.wp-core-ui .customize-section-back:focus {
	border-right-color: var( --ast-customizer-primary-color );
}
...
.ast-description.ast-customizer-notice{
    background: var(--ast-customizer-notice-background);
    border: 1px solid var(--ast-customizer-border-color);
    padding: 14px;
    border-radius: 4px;
...
#customize-control-astra-settings-ast-callback-notice-header-transparent-meta-enabled-with-link a.customizer-link.ast-description-text {
    margin-right: 30px;
	cursor: pointer;
}
...
.ast-font-extras-wrapper .ast-units-wrapper,
.ast-font-spacing-wrapper .ast-units-wrapper {
	position: relative;
	top: auto;
	left: auto;
}
...
.ast-font-decoration-wrapper div.active {
	background-color: var( --ast-customizer-primary-color );
	color: #fff;
	cursor: pointer;
}
...
.components-button-group.ahfb-radio-container-control label:hover svg,
.input-wrapper.ast-alignment-wrapper .ast-alignment-inner-wrap:hover {
	background-color: var( --ast-customizer-color-13 );
}

.ast-font-transform-container,
.ast-font-decoration-container {
	position: relative;
	flex: 1;
}

@media ( min-width: 1601px ) {
	.ast-font-styling-second .ast-font-decoration-container > .ast-control-tooltip {
		margin-right: 106px;
	}
}

@media ( min-width: 1600px ) and ( max-width: 1700px ) {
	.ast-font-decoration-container > .ast-control-tooltip {
		margin-right: 86px;
	}
}
...
.ast-font-decoration-container > .ast-control-tooltip:hover {
	color: var( --ast-customizer-primary-color );
}

.ast-font-decoration-container > .ast-tooltip {
	position: absolute;
	top: -11px;
	right: 0;
	width: 20px;
...
.ast-font-decoration-container .ast-tooltip[data-title]::after {
	max-width: none;
}

.ast-font-decoration-container .dashicons-editor-help[data-title] + .ast-tooltip[data-title]::before,
.ast-font-decoration-container .dashicons-editor-help[data-title] + .ast-tooltip[data-title]::after {
	right: -78px;
}
...
.ast-font-decoration-container .ast-tooltip[data-title]::before {
	bottom: calc( 100% + 9px );
}
...
.ast-social-icon-type-selection {
	display: flex;
}

.ast-social-icon-type-selection .ast-social-icon-type-btn {
	border-radius: unset;
	color: var( --ast-customizer-color-5 );
	width: 100%;
	justify-content: center;
...
.ast-social-icon-type-selection .ast-social-icon-type-btn.is-primary {
	color: var( --ast-customizer-color-10 );
	border-color: var(--ast-customizer-color-3);
	background: var(--ast-customizer-color-1);
}
.ast-social-icon-type-selection .ast-social-icon-type-btn:focus, .ast-social-icon-type-selection .ast-social-icon-type-btn.is-secondary:focus {
	box-shadow: none !important;
}
.ast-social-icon-type-selection .ast-social-icon-type-btn:not( .is-primary ):hover {
	background: none;
    box-shadow: none;
}
.ast-social-icon-type-selection .ast-social-icon-type-btn:last-child {
	border-radius: 3px 0 0 3px;
}
...
.ast-logo-svg-icon-search-bar input[type="text"] {
	height: 36px;
	width: 100%;
	padding: 7px calc( 12px * 2 + 14px ) 7px 12px;
...
.customize-control-ast-responsive-spacing .input-wrapper .ast-spacing-wrapper:has( li:nth-child( 5 ) input.ast-spacing-input:is( :focus, :hover, :active ) ) li.ast-spacing-input-item-link {
	border-right-color: var(--ast-customizer-color-1);
}
...
.customize-control select,
.customize-control input:not([type="checkbox"]):not([type="radio"]),
.customize-control textarea,
.customize-control-content .components-text-control__input {
	min-height: 32px;
}
...
.ast-title-bold .customize-control-title {
	font-weight: 600;
}
...
.ast-slider-wrap:has(input[type="range"]:focus) .components-range-control__root {
    z-index: 1;
}
...
.customize-control-ast-sortable .sortable .ast-sortable-item > i.remove-sortable-item svg {
	position: relative;
	top: 1px;
}
...
.dashicons-editor-help[data-title] + .ast-tooltip[data-title]::after {
	left: -2px;
	right: initial;
...
.ast-upgrade-list-items .ast-upgrade-list-items-title-wrapper {
	display: flex;
	gap: 7px;
}
...
.ast-upgrade-list-items .ast-upgrade-list-items-subtitle {
	font-size: 12px;
	line-height: 16px;
	margin: 8px 0 0;
}
