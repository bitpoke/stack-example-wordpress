		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				array(
					...
					'sanitize_callback' => array( 'Astra_Customizer_Sanitizes', 'sanitize_global_color_palette' ),
				),
				...
				array(
					...
					'sanitize_callback' => array( 'Astra_Customizer_Sanitizes', 'sanitize_color_palettes' ),
				),
