...
abstract class ActionScheduler_Logger {
	...
	public function log_timed_out_action( $action_id, $timeout ) {
		...
		$this->log( $action_id, sprintf( __( 'action was in-progress for at least %s seconds without completing and has been marked as failed. Check server, PHP and database error logs to diagnose cause.', 'woocommerce' ), $timeout ) );
	}
