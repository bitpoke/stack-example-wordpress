	...
	<div class="wp-block-column" style="flex-basis:66.66%">
		...
		<div class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile has-text-color has-background" style="color:#ffffff;background-color:#000000">
			...
			<figure class="wp-block-media-text__media">
				<img src="<?php echo esc_url( plugins_url( 'images/pattern-placeholders/hand-guitar-finger-tshirt-clothing-rack.png', dirname( __FILE__ ) ) ); ?>" alt="<?php esc_attr_e( 'Placeholder image used to represent a product being showcased in a hero section.', 'woocommerce' ); ?>" class="wp-image-3800 size-full" />
			</figure>
		</div>
		<!-- /wp:media-text -->
	</div>
