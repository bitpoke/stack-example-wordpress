...
<div class="wp-block-columns alignwide" style="padding-right:32px;padding-left:32px">
	...
	<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:160px">
		...
		<figure class="wp-block-image is-resized is-style-rounded">
			<img src="https://s.w.org/images/core/5.8/portrait.jpg" alt="<?php esc_attr_e( 'Placeholder image with the avatar of the user who is writing the testimonial.', 'woocommerce' ); ?>" width="164"/>
		</figure>
		<!-- /wp:image -->
	</div>
	<!-- /wp:column -->
	...
	<div class="wp-block-column">
		<!-- wp:paragraph -->
		<p><strong><?php esc_html_e( 'Great experience', 'woocommerce' ); ?></strong></p>
		<!-- /wp:paragraph -->

		<!-- wp:paragraph -->
		<p><?php esc_html_e( 'In the end the couch wasn\'t exactly what I was looking for but my experience with the Burrow team was excellent. First in providing a discount when the couch was delayed, then timely feedback and updates as the...', 'woocommerce' ); ?></p>
		<!-- /wp:paragraph -->
