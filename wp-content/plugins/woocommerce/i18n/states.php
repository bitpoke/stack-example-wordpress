...
return array(
	...
	'HR' => array( // Croatian counties.
		'HR-01' => __( 'Zagreb County', 'woocommerce' ),
		'HR-02' => __( 'Krapina-Zagorje County', 'woocommerce' ),
		'HR-03' => __( 'Sisak-Moslavina County', 'woocommerce' ),
		'HR-04' => __( 'Karlovac County', 'woocommerce' ),
		'HR-05' => __( 'Varaždin County', 'woocommerce' ),
		'HR-06' => __( 'Koprivnica-Križevci County', 'woocommerce' ),
		'HR-07' => __( 'Bjelovar-Bilogora County', 'woocommerce' ),
		'HR-08' => __( 'Primorje-Gorski Kotar County', 'woocommerce' ),
		'HR-09' => __( 'Lika-Senj County', 'woocommerce' ),
		'HR-10' => __( 'Virovitica-Podravina County', 'woocommerce' ),
		'HR-11' => __( 'Požega-Slavonia County', 'woocommerce' ),
		'HR-12' => __( 'Brod-Posavina County', 'woocommerce' ),
		'HR-13' => __( 'Zadar County', 'woocommerce' ),
		'HR-14' => __( 'Osijek-Baranja County', 'woocommerce' ),
		'HR-15' => __( 'Šibenik-Knin County', 'woocommerce' ),
		'HR-16' => __( 'Vukovar-Srijem County', 'woocommerce' ),
		'HR-17' => __( 'Split-Dalmatia County', 'woocommerce' ),
		'HR-18' => __( 'Istria County', 'woocommerce' ),
		'HR-19' => __( 'Dubrovnik-Neretva County', 'woocommerce' ),
		'HR-20' => __( 'Međimurje County', 'woocommerce' ),
		'HR-21' => __( 'Zagreb City', 'woocommerce' ),
	),
